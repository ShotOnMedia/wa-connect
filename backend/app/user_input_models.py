...
class UserInputAnswer(Base):
    ...
    question_node_id:Mapped[int|None]=mapped_column(ForeignKey("flow_nodes.id",ondelete="CASCADE"),nullable=True,index=True)
    campaign_question_id:Mapped[int|None]=mapped_column(ForeignKey("campaign_questions.id",ondelete="SET NULL"),nullable=True,index=True)
