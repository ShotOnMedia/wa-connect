...
class FlowSessionOut(BaseModel):
    id:int; flow_id:int; flow_name:str; current_node_id:int|None=None; current_node_title:str|None=None; status:str; waiting_for:str|None=None; started_at:datetime; updated_at:datetime; ended_at:datetime|None=None
class ConversationOut(BaseModel):
    model_config=ConfigDict(from_attributes=True)
    id:int; phone_number_id:int; status:ConversationStatus; last_message_at:datetime|None; last_customer_message_at:datetime|None=None; service_window_expires_at:datetime|None=None; service_window_open:bool=False; contact:ContactOut; unread_count:int=0; last_message_body:str|None=None; last_message_direction:MessageDirection|None=None; assigned_user_id:int|None=None; assigned_user:AgentOut|None=None; flow_session:FlowSessionOut|None=None
