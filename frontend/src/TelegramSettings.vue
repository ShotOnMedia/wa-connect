  ...
  <div class="tg-settings">
    <div class="tg-grid">
      <form class="tg-card" @submit.prevent="connect">
        ...
        <div class="botfather-help">
          <div><strong>Need to create a bot?</strong><span>Open BotFather in Telegram, send <code>/newbot</code>, follow the prompts, then copy the API token it gives you.</span></div>
          <a href="https://t.me/BotFather" target="_blank" rel="noopener noreferrer">Open BotFather ↗</a>
        </div>
      ...
      <section class="tg-card bots-card">
        ...
        <div v-else-if="!bots.length" class="empty"><strong>No Telegram bot connected yet</strong><span>Create a bot with BotFather, copy its API token and connect it here.</span><a class="empty-link" href="https://t.me/BotFather" target="_blank" rel="noopener noreferrer">Create one with BotFather ↗</a></div>
...
<style scoped>
.tg-settings{max-width:1180px}.tg-grid{display:grid;grid-template-columns:minmax(0,.95fr) minmax(0,1.05fr);gap:18px}.tg-card{background:#fff;border:1px solid #dce6e2;border-radius:14px;padding:22px;box-shadow:0 3px 14px rgba(21,57,43,.04)}.tg-card-head{display:flex;gap:13px;margin-bottom:16px}.tg-card-head h2,.section-head h2{margin:0 0 5px}.tg-card-head p{margin:0;color:#74867e;line-height:1.5;font-size:13px}.tg-icon,.tg-avatar{display:grid;place-items:center;background:#229ed9;color:#fff;font-weight:900}.tg-icon{width:42px;height:42px;border-radius:12px;flex:0 0 auto}.tg-avatar{width:38px;height:38px;border-radius:11px;flex:0 0 auto}.botfather-help{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:20px;padding:13px 14px;border:1px solid #cfe7f2;border-radius:10px;background:#f3faff}.botfather-help strong,.botfather-help span{display:block}.botfather-help strong{font-size:12px;color:#1f4f65}.botfather-help span{margin-top:3px;color:#667e89;font-size:11px;line-height:1.45}.botfather-help code{padding:1px 4px;border-radius:4px;background:#e5f4fb;color:#1679a8;font-size:10px}.botfather-help a,.empty-link{flex:0 0 auto;text-decoration:none;border:1px solid #229ed9;background:#229ed9;color:#fff;border-radius:8px;padding:9px 11px;font-size:11px;font-weight:800}.tg-form-grid{display:grid;grid-template-columns:1fr 1fr;gap:13px}.tg-form-grid label{display:flex;flex-direction:column;gap:6px;font-size:12px;font-weight:700}.tg-form-grid label.wide{grid-column:1/-1}.tg-form-grid input{border:1px solid #d2ded9;border-radius:8px;padding:10px 11px;font:inherit}.tg-form-grid small{font-weight:400;color:#82938c}.tg-actions{display:flex;justify-content:flex-end;gap:9px;margin-top:18px}.tg-actions button,.bot-row button{padding:9px 12px;border-radius:8px;font-weight:700;cursor:pointer}.secondary{border:1px solid #d4dfda;background:#fff;color:#29453a}.primary{border:1px solid #168b65;background:#168b65;color:white}.tg-preview{margin-top:16px;padding:12px;border-radius:10px;background:#f1f8f5;display:flex;align-items:center;gap:10px}.tg-preview div{flex:1}.tg-preview strong,.tg-preview b,.tg-preview small{display:block}.tg-preview b{font-size:12px;color:#229ed9;margin-top:2px}.tg-preview small{font-size:10px;color:#788a82;margin-top:2px}.tg-preview i{font-style:normal;color:#18845f;font-size:11px;font-weight:800}.tg-success,.tg-error{padding:10px 12px;border-radius:8px;font-size:12px}.tg-success{background:#eef9f3;color:#16724f}.tg-error{background:#fff0f0;color:#9c2929}.section-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px}.section-head .eyebrow{margin:0;color:#229ed9;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.08em}.refresh{border:1px solid #d9e3df;background:#fff;border-radius:8px;padding:7px 10px;cursor:pointer}.empty{padding:32px 10px;text-align:center;color:#7d8f87}.empty strong,.empty span{display:block}.empty span{font-size:12px;margin-top:6px}.empty-link{display:inline-block;margin-top:13px}.bot-row{display:grid;grid-template-columns:auto 1fr auto auto;align-items:center;gap:11px;padding:14px 0;border-top:1px solid #edf1ef}.bot-copy strong,.bot-copy span,.bot-copy small{display:block}.bot-copy span{color:#229ed9;font-size:12px;margin-top:2px}.bot-copy small{color:#899991;font-size:10px;margin-top:3px}.bot-status{padding:4px 7px;border-radius:999px;background:#e9f7f1;color:#177657;font-size:10px;font-weight:800}.bot-status.off{background:#f2f2f2;color:#777}.health{grid-column:2/-1;padding:10px 12px;border-radius:8px;background:#edf8f4;color:#4d6e62}.health.bad{background:#fff0f0;color:#8d3535}.health b,.health span,.health small{display:block}.health span{font-size:11px;word-break:break-all;margin:3px 0}.health small{font-size:10px}@media(max-width:950px){.tg-grid{grid-template-columns:1fr}}@media(max-width:620px){.tg-form-grid{grid-template-columns:1fr}.tg-form-grid label.wide{grid-column:auto}.bot-row{grid-template-columns:auto 1fr}.bot-row>.bot-status,.bot-row>button{grid-column:auto}.health{grid-column:1/-1}.botfather-help{align-items:flex-start;flex-direction:column}.botfather-help a{align-self:flex-start}}
</style>